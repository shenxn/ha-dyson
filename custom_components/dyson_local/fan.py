...
from libdyson import DysonPureCool, DysonPureCoolLink
...
async def async_setup_entry(
    ...
    if isinstance(device, DysonPureCoolLink):
        async_add_entities([DysonPureCoolLinkEntity(device, name)])
    elif isinstance(device, DysonPureCool):
        async_add_entities([DysonPureCoolEntity(device, name)])
    else:  # DysonPureHumidityCool
        async_add_entities([DysonPureHumidifyCoolEntity(device, name)])
